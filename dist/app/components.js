...
__export(require('./sidebar/leftSidebar'));
__export(require('./rightSidebar/rightSidebar'));
__export(require('./smallChat/smallChat'));
__export(require('./footerComponent/footerComponent'));
